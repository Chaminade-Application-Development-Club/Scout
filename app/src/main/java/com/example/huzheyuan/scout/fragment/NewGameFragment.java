package com.example.huzheyuan.scout.fragment;
...
public class NewGameFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_new_game,container);
        spinner = (Spinner) view.findViewById(R.id.spinFrcTeamNumber);
        numberPicker = (NumberPicker) view.findViewById(R.id.numberPickerID);
